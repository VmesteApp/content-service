...
class PulseAdapter:
    ...
    def request_to_delete_pulse_input_dto(cls, pulse_id: int) -> DeletePulseInputDto:
        delete_pulse_input_dto = {'pulse_id': pulse_id}
    ...
    @classmethod
    def update_pulse_output_dto_to_response(cls, update_pulse_output_dto: UpdatePulseOutputDto) -> str:
        return asdict(update_pulse_output_dto)

    @classmethod
    def delete_pulse_output_dto_to_response(cls, delete_pulse_output_dto: DeletePulseOutputDto) -> str:
        return asdict(delete_pulse_output_dto)

    @classmethod
    def get_pulses_output_dto_to_response(cls, get_pulses_output_dto: List[GetPulseOutputDto]) -> str:
        result = []
